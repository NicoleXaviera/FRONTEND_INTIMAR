                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <th>
                                                                            ...
                                                                            <input
                                                                                ...
                                                                                style={{width: "150px"}} // Establecer el ancho de la barra de búsqueda
                                                                            />
                                                                        </th>
                                                                        <th>
                                                                            ...
                                                                            <input
                                                                                ...
                                                                                style={{width: "200px"}} // Establecer el ancho de la barra de búsqueda
                                                                            />
                                                                        </th>
                                                                        <th>
                                                                            Teléfono <br />
                                                                    ...
                                                                    {filteredClients.map((client) => (
                                                                        <tr
                                                                            key={client.id}
                                                                            style={{
                                                                                backgroundColor: selectedRow === client.id ? '#c8cbce' : 'white', // Cambiar el color de fondo cuando está seleccionada
